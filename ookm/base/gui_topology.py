...
# Disable ws_topology so it doesn't conflict with app_manager
# This disables auto refreshing of topology display
# A better way is to remove set_ev_cls in ws_topology and add the rpc calls in app_manager
